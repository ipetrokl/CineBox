...
public partial class CineBoxV1Context : DbContext
{
    public CineBoxV1Context()
    {
    }

    public CineBoxV1Context(DbContextOptions<CineBoxV1Context> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=localhost,1434;Initial Catalog=CineBoxV1;user=sa;Password=1!vanPetrovic;TrustServerCertificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Actor>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Actor__3213E83F06FC3336");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Booking__3213E83FFB26D1F7");
            ...
            entity.HasMany(d => d.Seats).WithMany(p => p.Bookings)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("BookingId", "SeatId").HasName("PK__BookingS__84E57B681EA03D4E");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Cinema__3213E83FC69D13DA");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Genre__3213E83F461443DC");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Hall__3213E83F7E19CA3D");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Movie__3213E83F1C9A4F8D");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__MovieAct__3213E83F91591449");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Payment__3213E83FD0CADCCC");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Promotio__3213E83F88F3B354");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Review__3213E83F6969966C");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Roles__3213E83F9CF430FE");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Screenin__3213E83F9677DA24");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Seat__3213E83FBC66AD3D");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Ticket__3213E83F66B02283");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__User__3213E83F2A58D0F2");
        ...
        {
            entity.HasKey(e => new { e.UserId, e.RoleId }).HasName("PK__UsersRol__6EDEA153C4FB5563");
